...
public:
   ...
   public:
      iterator( vector<Data>* b,vector<Data>* end,size_t i): _thisBuckets(b), _end(end), idx(i) {}
      ~iterator(){}
   ...
   iterator begin() const { 
      for(vector<Data>* ptr = _buckets; ptr < _buckets + _numBuckets; ptr++){
         if(!ptr->empty()){
   ...
   bool check(const Data& d) const 
   {
      ...
      for(it = _buckets[bucketNum(d)].begin() ; it != _buckets[bucketNum(d)].end(); ++it)
      {
         // cout << "~~" << endl;
